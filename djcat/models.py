...
from .exceptions import CategoryInheritanceError, ItemModuleNameNotDefined, ItemModuleNameDuplicate, \
    ItemNameDuplicate, CategoryRootCheckError
...
class CatalogItem:
    ...
    #     # attrs[f.get_name()] = {
    #     #     'type': a.get_type(),
    #     #     'verbose_name': a.get_verbose_name(),
    #     #     'key': a.get_key(),
    #     #     'class': a.get_class(),
    #     #     '_class': f._attr_class
    #     # }
    #
    ...
    #         if getattr(f, '_attr_class', None):
    #             a = f._attr_class()
    #             a.validate(self.__class__.REGISTRY)
    #             attrs[f.get_name()] = {
    #                 'type': a.get_type(),
    #                 'verbose_name': a.get_verbose_name(),
    #                 'key': a.get_key(),
...
class Path:
    """
    TODO: update REGISTRY with paths?
    """
    pass
